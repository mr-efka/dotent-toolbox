...
{
    /// <summary>
    /// Registers <see cref="T:ToolBox.QueryString.IQueryStringHelper"/> in the given <paramref name="services"/> container with the defined <paramref name="configuration"/> and <paramref name="lifetime"/>.
    /// </summary>
    ...
    /// <summary>
    /// Registers <see cref="T:ToolBox.QueryString.IQueryStringHelper"/> in the given <paramref name="services"/> container as a <see cref="ServiceLifetime.Scoped"/> service.
    /// </summary>
    /// <param name="services">IoC container</param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Registers <see cref="T:ToolBox.QueryString.IQueryStringHelper"/> in the given <paramref name="services"/> container as a <see cref="ServiceLifetime.Scoped"/> service using the provided <paramref name="configuration"/>.
    /// </summary>
    /// <param name="services">IoC container</param>
    ...
    /// <summary>
    /// Registers <see cref="T:ToolBox.QueryString.IQueryStringHelper"/> in the given <paramref name="services"/> container with the provided <paramref name="lifetime"/>.
    /// </summary>
    /// <param name="services">IoC container</param>
